...
if __name__ == '__main__':
    ...
    "비츠로테크", "클래시스", "에이피알", "원텍", "비올", "휴젤", "파마리서치", "대웅제약", "메디톡스", "바이오플러스", "휴메딕스",
    "한국비엔씨", "삼성전자", "SK하이닉스", "DB하이텍", "솔브레인", "한솔케미칼", "동진쎄미켐", "이엔에프테크놀로지", "티씨케이",
    "하나머티리얼즈", "원익QnC", "월덱스", "비씨엔씨", "케이엔제이", "에스앤에스텍", "에프에스티", "코미코", "한솔아이원스",
    "HPSP", "주성엔지니어링", "원익IPS", "유진테크", "케이씨텍", "피에스케이", "테스", "브이엠", "파크시스템스", "넥스틴",
    "오로스테크놀로지", "펨트론", "인텍플러스", "제우스", "와이씨", "하나마이크론", "SFA반도체", "한양디지텍", "두산테스나",
    "에이팩트", "이수페타시스", "대덕전자", "심텍", "해성디에스", "티엘비", "리노공업", "ISC", "티에스이", "티에프이", "오킨스전자",
    "마이크로컨텍솔", "샘씨엔에스", "가온칩스", "에이직랜드", "오픈엣지테크놀로지", "코아시아", "에이디테크놀로지", "SKC",
    "필옵틱스", "제이앤티씨", "켐트로닉스", "와이씨켐", "네오셈", "퀄리타스반도체", "티엘비", "엑시콘", "자람테크놀로지",
    "신성이엔지", "케이엔솔", "GST", "에치에프알", "RFHIC", "쏠리드", "HD현대중공업", "HD현대미포", "삼성중공업", "한화오션",
    "HJ중공업", "HD현대마린엔진", "STX엔진", "한화엔진", "한국카본", "동성화인텍", "한라IMS", "대양전기공업", "세진중공업",
    "인화정공", "현대힘스", "한화에어로스페이스", "현대로템", "LIG넥스원", "한국항공우주", "한화시스템", "아이쓰리시스템",
    "엠앤씨솔루션", "SNT다이내믹스", "롯데케미칼", "금호석유화학", "유니드", "루닛", "뷰노", "쓰리빌리언", "온코크로스", "NAVER",
    "카카오", "더존비즈온", "엠로", "이스트소프트", "솔트룩스", "한글과컴퓨터", "카페24", "HD현대일렉트릭", "일진전기", "제룡전기",
    "효성중공업", "LS ELECTRIC", "산일전기", "대한전선", "대원전선", "가온전선", "LS에코에너지", "LS마린솔루션", "두산에너빌리티",
    "비에이치아이", "현대건설", "시프트업", "크래프톤", "컴투스", "넷마블", "삼성바이오로직스", "바이넥스", "에스티팜", "셀트리온",
    "SK바이오팜", "알테오젠", "유한양행", "디앤디파마텍", "현대엘리베이터", "아난티", "대아티아이", "브이티", "실리콘투",
    "한국콜마", "코스맥스", "한국화장품제조", "코스메카코리아", "씨앤씨인터내셔널", "아이패밀리에스씨", "아모레퍼시픽",
    "LG생활건강", "토니모리", "마녀공장", "선진뷰티사이언스", "펌텍코리아", "현대차", "기아", "LG에너지솔루션", "삼성SDI",
    "SK이노베이션", "에코프로", "이수스페셜티케미컬", "레이크머티리얼즈", "한농화성", "넥스틸", "세아제강", "세아제강지주",
    "휴스틸", "태광", "하이록코리아", "성광벤드", "SK가스", "포스코인터내셔널", "현대오토에버", "에스오에스랩", "레인보우로보틱스",
    "두산로보틱스", "하이젠알앤엠", "로보티즈", "유일로보틱스", "씨메스", "클로봇", "알에스오토메이션", "뉴로메카", "삼현",
    "원익홀딩스", "대동기어", "전진건설로봇", "HD현대건설기계", "HD현대인프라코어", "SG", "TYM", "HD현대에너지솔루션",
    "한화솔루션", "SK이터닉스", "대명에너지", "HDC현대산업개발", "대우건설", "GS건설", "삼성E&A", "삼성물산", "HMM",
    "팬오션", "STX그린로지스", "삼양식품", "에스앤디", "농심", "빙그레", "풀무원", "롯데웰푸드", "오리온", "해태제과식품",
